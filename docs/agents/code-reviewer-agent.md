...
- `code-review-pr`
- `worktree-task-isolation` when local checkout is needed
- `github-pr-workflow`
...
- use isolated review worktrees for local checkout or smoke checks
...
- Do not run local checkout or smoke checks in a shared project root.
