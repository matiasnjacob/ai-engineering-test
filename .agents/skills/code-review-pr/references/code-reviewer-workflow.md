...
- branch name does not follow `feature/task-{number}-{kebab-case-name}` and no exception was approved
...
- PR missing Task ID
- branch violates required naming pattern without approved exception
